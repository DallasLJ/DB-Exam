    ...
    <div class="main">
        ...
        <div class="context">
            <div class="lab-full" style="margin-bottom:10px;font-weight:700;">
                在线练习
                <a href="<?php echo ($prourl); ?>" style="float:right;margin-right:30px;">考试题目集</a>
            </div>
			<table class="bordered" style="margin-bottom:10px;">
				<thead>
					<tr>
                        <th style="width:35px;text-align:center">选中</th>
				...
				<tbody>
					<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                            <td style="text-align:center"><input type="checkbox" name="pid" value="<?php echo ($vo['id']); ?>" style="height: auto;margin: 0;"></td>
							...
							<td>
								<?php switch($vo['typeid']): case "1": ?>查找题<?php break;?>
									...
									<?php case "4": ?>更新题<?php break; endswitch;?>
							</td>	
						</tr><?php endforeach; endif; else: echo "" ;endif; ?>
				</tbody>
			</table>
            <button id="subbtn" style="float:left;">提交</button>
		</div>
