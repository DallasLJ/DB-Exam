...
<body>
    ...
    <div class="main">
        ...
        <div class="context">
            <div class="lab input-tittle" style="margin-bottom:10px;">更新题目</div>
            <form name="addForm" action="/index.php/Home/Problem/update/pid/22.html" onsubmit="return validateForm()" method="post">
                <div class="inputdiv">
                    <div>题目id：</div>
                    <input type="text" name="id" value="<?php echo ($data['id']); ?>">
                    <br/>
                    <div>题目类型:</div>
                    <input type="text" name="typeid" value="<?php echo ($data['typeid']); ?>">
                    <br/>
                    <div>题目标题:</div>
                    ...
                    <br/>
                    <div>题目描述:</div>
                    <textarea class="txtarea" rows="10" cols="20" name="content"><?php echo ($data['content']); ?></textarea>
                    <br/>                    
                    <div>答案</div>
                    <textarea class="txtarea" rows="10" cols="20" name="answer"><?php echo ($data['answer']); ?></textarea>
                </div>
